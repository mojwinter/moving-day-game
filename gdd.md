...
### Night 4: The Toy Soldiers (Magnets/Logic)
* **Anchor:** Action Figures on the shelf.
* **Mechanic:** Exclusion Logic.
* **Rules:** Place "Red" and "Blue" units on a grid. A Red unit cannot be adjacent (orthogonal) to another Red unit. Same for Blue.
* **Win Condition:** Fill all target slots validly.
